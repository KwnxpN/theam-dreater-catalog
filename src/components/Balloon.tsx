...
import popSoundFile from '../assets/mp3/fahhhhh.mp3';
...
export const Balloon: React.FC<BalloonProps> = ({ id, x, imageUrl, onClick, onDestroy }) => {
  ...
  return (
    ...
    >
      {/* Balloon Base Body */}
      <div
        className="w-full h-full relative shadow-lg overflow-hidden transition-transform duration-300 group-hover:scale-105 rounded-full"
        style={{
