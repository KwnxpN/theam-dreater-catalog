  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`absolute w-full h-px pointer-events-none opacity-0 transform translate-y-1/2 bg-black dark:bg-white`}
      ></div>
      <div
        ref={lineVerticalRef}
        className={`absolute h-full w-px pointer-events-none opacity-0 transform translate-x-1/2 bg-black dark:bg-white`}
      ></div>
    </div>
  );
};
